...
public class FrontEnd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (hiddenParam) {
            case "login":
                ...
                if (isAuthenticated) {
                    ...
                    RequestDispatcher requestDispatcher = request.
                            getRequestDispatcher("withlogin.jsp");
                   ...
                   RequestDispatcher requestDispatcher = request.
                            getRequestDispatcher("withoutlogin.jsp");
            ...
            case "search":
                ...
                ScholarshipXML result;
                String query = request.getParameter("query");
                if (token.isEmpty()) {
                    result = retreiveServicesFromBackend(query, null);
                    request.setAttribute("scholarshipResults", result);
                    ...
                    RequestDispatcher requestDispatcher = request.getRequestDispatcher("withlogin.jsp");
    ...
    private ScholarshipXML retreiveServicesFromBackend(String query, String token) {
        try {
